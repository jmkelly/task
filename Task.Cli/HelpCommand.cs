...
namespace Task.Cli
{
    public class HelpCommand : AsyncCommand<HelpCommand.Settings>
    {
        ...
        public override async Task<int> ExecuteAsync(CommandContext context, Settings settings, CancellationToken cancellationToken)
        {
            ...
            AnsiConsole.WriteLine("- Requires .NET 8.0 or later");
            ...
            AnsiConsole.WriteLine("Report bugs at: https://github.com/anomalyco/opencode/issues");
            AnsiConsole.WriteLine();

            // DOCUMENTATION
            AnsiConsole.MarkupLine("[yellow]DOCUMENTATION[/]");
            AnsiConsole.WriteLine("Full documentation: https://opencode.ai/docs/task-cli");
            AnsiConsole.WriteLine("API reference: https://opencode.ai/docs/task-api");
            AnsiConsole.WriteLine("Community forum: https://github.com/anomalyco/opencode/discussions");
            AnsiConsole.WriteLine();

            // AUTHOR
            AnsiConsole.MarkupLine("[yellow]AUTHOR[/]");
            AnsiConsole.WriteLine("Written by the OpenCode team.");
            AnsiConsole.WriteLine();

            // COPYRIGHT
            AnsiConsole.MarkupLine("[yellow]COPYRIGHT[/]");
            AnsiConsole.WriteLine("Copyright (C) 2024 OpenCode. License MIT.");
            AnsiConsole.WriteLine();
