...
namespace Task.Core
{
    public interface ITaskService
    {
        ...
        System.Threading.Tasks.Task<TaskItem> AddTaskAsync(string title, string? description, string priority, DateTime? dueDate, List<string> tags, string? project = null, List<string>? dependsOn = null, string? status = "todo", CancellationToken cancellationToken = default);
