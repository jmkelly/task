...
";
        ...
        public async System.Threading.Tasks.Task DeleteTask(string id, CancellationToken cancellationToken = default)
        {
            using var connection = new SqliteConnection($"Data Source={_dbPath}");
            await connection.OpenAsync(cancellationToken);
        ...
        public async System.Threading.Tasks.Task CompleteTask(string id, CancellationToken cancellationToken = default)
        {
            using var connection = new SqliteConnection($"Data Source={_dbPath}");
            await connection.OpenAsync(cancellationToken);
        ...
        public async System.Threading.Tasks.Task<List<TaskItem>> SearchTasksFTS(string query, CancellationToken cancellationToken = default)
        {
...
ORDER BY rank";
        ...
        public async System.Threading.Tasks.Task<List<TaskItem>> SearchTasksSemantic(string query, CancellationToken cancellationToken = default)
        {
        ...
        public async System.Threading.Tasks.Task<List<TaskItem>> SearchTasksHybrid(string query, CancellationToken cancellationToken = default)
        {
        ...
        public async System.Threading.Tasks.Task<List<string>> GetAllUniqueTags(CancellationToken cancellationToken = default)
        {
        ...
        public async System.Threading.Tasks.Task<TaskItem> AddTask(string title, string? description, string priority, DateTime? dueDate, List<string> tags, CancellationToken cancellationToken = default)
        {
            using var connection = new SqliteConnection($"Data Source={_dbPath}");
            await connection.OpenAsync(cancellationToken);
            using SqliteTransaction transaction = (SqliteTransaction)await connection.BeginTransactionAsync(cancellationToken);
...
VALUES (@uid, @title, @description, @priority, @dueDate, @tags, 'todo', @createdAt, @updatedAt)";
        ...
        public async System.Threading.Tasks.Task<TaskItem?> GetTaskByUid(string uid, CancellationToken cancellationToken = default)
        {
            using var connection = new SqliteConnection($"Data Source={_dbPath}");
            await connection.OpenAsync(cancellationToken);
        ...
        public async System.Threading.Tasks.Task UpdateTask(TaskItem task, CancellationToken cancellationToken = default)
        {
            using var connection = new SqliteConnection($"Data Source={_dbPath}");
            await connection.OpenAsync(cancellationToken);
            using SqliteTransaction transaction = (SqliteTransaction)await connection.BeginTransactionAsync(cancellationToken);
...
WHERE id = @id";
        ...
        public async System.Threading.Tasks.Task<List<TaskItem>> GetAllTasks(CancellationToken cancellationToken = default)
        {
            var tasks = new List<TaskItem>();
            using var connection = new SqliteConnection($"Data Source={_dbPath}");
            await connection.OpenAsync(cancellationToken);
